...
def delete_endpoint(endpoint_name, sm_client):
...
def delete_endpoint_config(config_name, sm_client):
...
def delete_model(model_name, sm_client):
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python cleanup.py <endpoint-name>")
        print("       python cleanup.py --list")

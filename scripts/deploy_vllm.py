...
# Format: {registry}/djl-inference:{version}-lmi{lmi_version}-{cuda}
...
def main():
    ...
    print(f"  python scripts/test_openai_endpoint.py {endpoint_name}")
    print(f"\nCleanup when done:")
    print(f"  python scripts/cleanup.py {endpoint_name}")

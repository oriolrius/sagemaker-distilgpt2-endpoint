...
class SageMakerOpenAIClient:
    ...
    def __init__(self, endpoint_name, region=REGION):
    ...
    def _invoke_streaming(self, payload):
...
def test_chat_completion(endpoint_name):
...
def test_streaming(endpoint_name):
...
def test_legacy_format(endpoint_name):
...
def main():
    ...
    if not endpoint_name:
        ...
        print("Usage: python test_openai_endpoint.py <endpoint-name>")
        sys.exit(1)
